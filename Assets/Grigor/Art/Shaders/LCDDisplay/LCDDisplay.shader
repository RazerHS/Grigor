	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				Gradient gradient12 = NewGradient( 0, 2, 2, float4( 0.9960785, 0.09411766, 1, 0.002944991 ), float4( 0.04705883, 0.9843138, 0.9764706, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float2 texCoord18 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_Image = packedInput.ase_texcoord5.xy * _Image_ST.xy + _Image_ST.zw;
				float4 temp_output_32_0 = ( ( tex2D( _TextureSample0, uv_TextureSample0 ) * SampleGradient( gradient12, texCoord18.y ) * tex2D( _Image, uv_Image ) ) * _Brightness );
				
				surfaceDescription.BaseColor = temp_output_32_0.rgb;
				...
				surfaceDescription.Emission = temp_output_32_0.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_Image = packedInput.ase_texcoord2.xy * _Image_ST.xy + _Image_ST.zw;
				float4 temp_output_32_0 = ( ( tex2D( _TextureSample0, uv_TextureSample0 ) * SampleGradient( gradient12, texCoord18.y ) * tex2D( _Image, uv_Image ) ) * _Brightness );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Image = packedInput.ase_texcoord7.xy * _Image_ST.xy + _Image_ST.zw;
				float4 temp_output_32_0 = ( ( tex2D( _TextureSample0, uv_TextureSample0 ) * SampleGradient( gradient12, texCoord18.y ) * tex2D( _Image, uv_Image ) ) * _Brightness );
...
Node;AmplifyShaderEditor.SamplerNode;15;-1064.621,337.684;Inherit;True;Property;_Image;Image;0;0;Create;True;0;0;0;False;0;False;-1;877046d091ef5864fa99fa88e23bc78a;877046d091ef5864fa99fa88e23bc78a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;81,0;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;14;LCDDisplay;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;39;Surface Type;0;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;0;0;  Energy Conserving Specular;1;0;  Transmission,InvertActionOnDeselection;0;0;Forward Only;0;0;Receive Decals;1;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-182.6254,86.48813;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-259.6254,233.4881;Inherit;False;Property;_Brightness;Brightness;1;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-1466.094,-268.1132;Inherit;False;Property;_NoiseScale;Noise Scale;2;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-523.5565,76.05965;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;36;-1085.384,-188.0205;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;f7c2f85613320ac4a970bc300111eab2;f7c2f85613320ac4a970bc300111eab2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GradientSampleNode;29;-1105.905,81.74378;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GradientNode;12;-1480.335,87.27055;Inherit;False;0;2;2;0.9960785,0.09411766,1,0.002944991;0.04705883,0.9843138,0.9764706,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;18;-1505.335,-110.514;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;29;1;18;2
ASEEND*/
//CHKSM=4A6922D356D56499AA2CB6B0CABFEFFA046A6599