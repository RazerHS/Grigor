	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 temp_output_33_0_g1 = float3(0,0,1);
				float2 texCoord39_g500 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode54_g500 = tex2D( _TextureSample0, ( texCoord39_g500 * float2( 1.5,1.5 ) * _DropSize ) );
				float2 appendResult47_g500 = (float2(tex2DNode54_g500.r , tex2DNode54_g500.g));
				float mulTime88_g500 = _TimeParameters.x * 0.2;
				float temp_output_55_0_g500 = ( ( tex2DNode54_g500.a * 2.0 ) - 1.0 );
				float temp_output_32_0_g1 = _RainStrength;
				float temp_output_69_0_g500 = temp_output_32_0_g1;
				float temp_output_38_0_g1 = _Wetness;
				float clampResult99_g500 = clamp( temp_output_38_0_g1 , 0.0 , _MaximumDropWetness );
				float temp_output_66_0_g500 = ( ( ( frac( ( tex2DNode54_g500.b - ( mulTime88_g500 * _DropSpeed ) ) ) * saturate( temp_output_55_0_g500 ) ) + ( 1.0 - step( ( temp_output_55_0_g500 * -1.0 ) , 0.0 ) ) ) * ( saturate( packedInput.ase_normal.y ) * ( temp_output_69_0_g500 > 0.0 ? temp_output_69_0_g500 : clampResult99_g500 ) ) );
				float3 appendResult45_g500 = (float3(( ( ( appendResult47_g500 * float2( 2,2 ) ) - float2( 1,1 ) ) * temp_output_66_0_g500 ) , 1.0));
				float eyeDepth = packedInput.ase_texcoord5.z;
				float cameraDepthFade93_g500 = (( eyeDepth -_ProjectionParams.y - 0.0 ) / 1.0);
				float3 lerpResult91_g500 = lerp( float3(0,0,1) , appendResult45_g500 , cameraDepthFade93_g500);
				float temp_output_106_32_g1 = temp_output_66_0_g500;
				float3 lerpResult12_g1 = lerp( temp_output_33_0_g1 , BlendNormal( temp_output_33_0_g1 , lerpResult91_g500 ) , saturate( temp_output_106_32_g1 ));
				float temp_output_36_0_g494 = temp_output_32_0_g1;
				float4 appendResult37_g494 = (float4(temp_output_36_0_g494 , temp_output_36_0_g494 , temp_output_36_0_g494 , temp_output_36_0_g494));
				float4 temp_output_41_0_g494 = saturate( ( ( appendResult37_g494 - float4( 0,0.25,0.5,0.75 ) ) * float4( 4,4,4,4 ) ) );
				float4 break48_g494 = temp_output_41_0_g494;
				float4 appendResult11_g494 = (float4(_TimeParameters.x , _TimeParameters.x , _TimeParameters.x , _TimeParameters.x));
				float4 break47_g494 = frac( ( ( ( appendResult11_g494 * float4( 1,0.85,0.93,0.7 ) ) + float4( 0,0.2,0.45,0.7 ) ) * float4( 1.6,1.6,1.6,1.6 ) ) );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float2 temp_output_24_0_g492 = (ase_worldPos).xz;
				float2 temp_output_24_0_g494 = temp_output_24_0_g492;
				float4 tex2DNode19_g499 = tex2D( _TextureSample2, ( ( temp_output_24_0_g494 * float2( 0.7,0.7 ) ) * _RippleSize1 ) );
				float temp_output_1_0_g499 = frac( ( break47_g494.x + tex2DNode19_g499.a ) );
				float clampResult13_g499 = clamp( ( ( ( temp_output_1_0_g499 - 1.0 ) + tex2DNode19_g499.r ) * 20.0 ) , 0.0 , 5.0 );
				float2 appendResult8_g499 = (float2(tex2DNode19_g499.g , tex2DNode19_g499.b));
				float3 appendResult17_g499 = (float3(( ( saturate( ( ( ( break48_g494.x * 0.8 ) + 0.2 ) - temp_output_1_0_g499 ) ) * sin( ( clampResult13_g499 * PI ) ) ) * ( ( appendResult8_g499 * float2( 2,2 ) ) - float2( 1,1 ) ) ) , 1.0));
				float3 temp_output_7_0_g495 = ( appendResult17_g499 * _RippleNormalStrength );
				float4 temp_output_2_0_g495 = temp_output_41_0_g494;
				float4 break39_g495 = temp_output_2_0_g495;
				float4 tex2DNode19_g498 = tex2D( _TextureSample2, ( ( ( temp_output_24_0_g494 + float2( -0.55,0.3 ) ) * float2( 0.75,0.75 ) ) * _RippleSize1 ) );
				float temp_output_1_0_g498 = frac( ( break47_g494.y + tex2DNode19_g498.a ) );
				float clampResult13_g498 = clamp( ( ( ( temp_output_1_0_g498 - 1.0 ) + tex2DNode19_g498.r ) * 20.0 ) , 0.0 , 5.0 );
				float2 appendResult8_g498 = (float2(tex2DNode19_g498.g , tex2DNode19_g498.b));
				float3 appendResult17_g498 = (float3(( ( saturate( ( ( ( break48_g494.y * 0.8 ) + 0.2 ) - temp_output_1_0_g498 ) ) * sin( ( clampResult13_g498 * PI ) ) ) * ( ( appendResult8_g498 * float2( 2,2 ) ) - float2( 1,1 ) ) ) , 1.0));
				float3 temp_output_8_0_g495 = ( appendResult17_g498 * _RippleNormalStrength );
				float4 tex2DNode19_g496 = tex2D( _TextureSample2, ( ( ( temp_output_24_0_g494 + float2( 0.6,0.85 ) ) * float2( 0.65,0.65 ) ) * _RippleSize1 ) );
				float temp_output_1_0_g496 = frac( ( break47_g494.z + tex2DNode19_g496.a ) );
				float clampResult13_g496 = clamp( ( ( ( temp_output_1_0_g496 - 1.0 ) + tex2DNode19_g496.r ) * 20.0 ) , 0.0 , 5.0 );
				float2 appendResult8_g496 = (float2(tex2DNode19_g496.g , tex2DNode19_g496.b));
				float3 appendResult17_g496 = (float3(( ( saturate( ( ( ( break48_g494.z * 0.8 ) + 0.2 ) - temp_output_1_0_g496 ) ) * sin( ( clampResult13_g496 * PI ) ) ) * ( ( appendResult8_g496 * float2( 2,2 ) ) - float2( 1,1 ) ) ) , 1.0));
				float3 temp_output_9_0_g495 = ( appendResult17_g496 * _RippleNormalStrength );
				float4 tex2DNode19_g497 = tex2D( _TextureSample2, ( ( ( temp_output_24_0_g494 + float2( 0.6,-0.75 ) ) * float2( 0.72,0.72 ) ) * _RippleSize1 ) );
				float temp_output_1_0_g497 = frac( ( break47_g494.w + tex2DNode19_g497.a ) );
				float clampResult13_g497 = clamp( ( ( ( temp_output_1_0_g497 - 1.0 ) + tex2DNode19_g497.r ) * 20.0 ) , 0.0 , 5.0 );
				float2 appendResult8_g497 = (float2(tex2DNode19_g497.g , tex2DNode19_g497.b));
				float3 appendResult17_g497 = (float3(( ( saturate( ( ( ( break48_g494.w * 0.8 ) + 0.2 ) - temp_output_1_0_g497 ) ) * sin( ( clampResult13_g497 * PI ) ) ) * ( ( appendResult8_g497 * float2( 2,2 ) ) - float2( 1,1 ) ) ) , 1.0));
				float3 temp_output_10_0_g495 = ( appendResult17_g497 * _RippleNormalStrength );
				float4 appendResult27_g495 = (float4((temp_output_7_0_g495).z , (temp_output_8_0_g495).z , (temp_output_9_0_g495).z , (temp_output_10_0_g495).z));
				float4 lerpResult29_g495 = lerp( float4( 1,1,1,1 ) , appendResult27_g495 , temp_output_2_0_g495);
				float4 break38_g495 = lerpResult29_g495;
				float3 appendResult36_g495 = (float3(( ( (temp_output_7_0_g495).xy * break39_g495.x ) + ( (temp_output_8_0_g495).xy * break39_g495.y ) + ( (temp_output_9_0_g495).xy * break39_g495.z ) + ( (temp_output_10_0_g495).xy * break39_g495.w ) ) , ( break38_g495.x * break38_g495.y * break38_g495.z * break38_g495.w )));
				float3 normalizeResult37_g495 = normalize( appendResult36_g495 );
				float lerpResult18_g493 = lerp( 0.05733212 , 0.1 , saturate( _WindStrength ));
				float3 break5_g493 = ase_worldPos;
				float4 appendResult6_g493 = (float4(break5_g493.x , break5_g493.z , break5_g493.x , break5_g493.z));
				float mulTime9_g493 = _TimeParameters.x * 0.2;
				float4 temp_output_8_0_g493 = ( ( appendResult6_g493 * _NormalTiling ) + ( ( mulTime9_g493 * float4(0.4,-0.1,0.02,0.4) * _WindSpeed ) * _NormalTiling ) );
				float3 tex2DNode27_g493 = UnpackNormalScale( tex2D( _WaterNormal, (temp_output_8_0_g493).xy ), 1.0f );
				float2 appendResult19_g493 = (float2(tex2DNode27_g493.r , tex2DNode27_g493.g));
				float3 tex2DNode29_g493 = UnpackNormalScale( tex2D( _WaterNormal1, (temp_output_8_0_g493).zw ), 1.0f );
				float2 appendResult20_g493 = (float2(tex2DNode29_g493.r , tex2DNode29_g493.g));
				float3 appendResult25_g493 = (float3(( lerpResult18_g493 * ( appendResult19_g493 + appendResult20_g493 ) ) , ( tex2DNode27_g493.b * tex2DNode29_g493.b )));
				float3 appendResult14_g492 = (float3((( normalizeResult37_g495 + appendResult25_g493 )).xy , 1.0));
				float2 lerpResult3_g492 = lerp( float2( 1E-05,0 ) , float2( 0.1,0.25 ) , _MaxPuddleSize);
				float2 break4_g492 = lerpResult3_g492;
				float temp_output_37_0_g492 = saturate( ( ( pow( saturate( packedInput.ase_normal.y ) , 30.0 ) * ( ( 1.0 - saturate( ( ( tex2D( _TextureSample1, ( temp_output_24_0_g492 * _PuddleSize ) ).g - break4_g492.y ) / break4_g492.x ) ) ) - ( 1.0 - temp_output_38_0_g1 ) ) ) * 1.1 ) );
				float3 lerpResult13_g492 = lerp( lerpResult12_g1 , appendResult14_g492 , temp_output_37_0_g492);
				
				float temp_output_42_0_g1 = _Smoothness;
				float2 appendResult8_g491 = (float2(temp_output_42_0_g1 , _Smoothness));
				float temp_output_6_0_g491 = saturate( ( ( saturate( temp_output_38_0_g1 ) * 0.7 ) + saturate( max( temp_output_37_0_g492 , temp_output_106_32_g1 ) ) ) );
				float2 lerpResult10_g491 = lerp( appendResult8_g491 , float2( 0.93,0.3 ) , temp_output_6_0_g491);
				float3 temp_cast_0 = ((lerpResult10_g491).y).xxx;
				
				surfaceDescription.BaseColor = float3( 0,0,0 );
				surfaceDescription.Normal = lerpResult13_g492;
				...
				surfaceDescription.Smoothness = (lerpResult10_g491).x;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float3 temp_output_33_0_g1 = float3(0,0,1);
				float2 texCoord39_g500 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode54_g500 = tex2D( _TextureSample0, ( texCoord39_g500 * float2( 1.5,1.5 ) * _DropSize ) );
				float2 appendResult47_g500 = (float2(tex2DNode54_g500.r , tex2DNode54_g500.g));
				float mulTime88_g500 = _TimeParameters.x * 0.2;
				float temp_output_55_0_g500 = ( ( tex2DNode54_g500.a * 2.0 ) - 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float3 temp_output_33_0_g1 = float3(0,0,1);
				float2 texCoord39_g500 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode54_g500 = tex2D( _TextureSample0, ( texCoord39_g500 * float2( 1.5,1.5 ) * _DropSize ) );
				float2 appendResult47_g500 = (float2(tex2DNode54_g500.r , tex2DNode54_g500.g));
				float mulTime88_g500 = _TimeParameters.x * 0.2;
				float temp_output_55_0_g500 = ( ( tex2DNode54_g500.a * 2.0 ) - 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float3 temp_output_33_0_g1 = float3(0,0,1);
				float2 texCoord39_g500 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode54_g500 = tex2D( _TextureSample0, ( texCoord39_g500 * float2( 1.5,1.5 ) * _DropSize ) );
				float2 appendResult47_g500 = (float2(tex2DNode54_g500.r , tex2DNode54_g500.g));
				float mulTime88_g500 = _TimeParameters.x * 0.2;
				float temp_output_55_0_g500 = ( ( tex2DNode54_g500.a * 2.0 ) - 1.0 );
...
Node;AmplifyShaderEditor.FunctionNode;487;2714.24,-197.1668;Inherit;False;Rain;1;;1;ccca7ec04c8f389498d9203a0179d6ad;0;9;75;FLOAT;1;False;39;FLOAT;0;False;40;FLOAT;0;False;41;FLOAT3;0,0,0;False;42;FLOAT;0;False;32;FLOAT;1;False;33;FLOAT3;0,0,1;False;34;FLOAT;0;False;38;FLOAT;0;False;4;FLOAT3;45;FLOAT3;0;FLOAT;43;FLOAT;44
WireConnection;0;0;487;0
WireConnection;0;1;487;45
WireConnection;0;5;487;43
WireConnection;0;7;487;44
WireConnection;0;9;437;0
WireConnection;487;75;430;0
WireConnection;487;39;271;0
WireConnection;487;40;271;0
WireConnection;487;41;434;0
WireConnection;487;42;271;0
WireConnection;487;32;269;0
WireConnection;487;33;436;0
WireConnection;487;34;185;0
WireConnection;487;38;268;0
ASEEND*/
//CHKSM=A6C3711AE734830331AA16796C8C7DBFC8C2231B